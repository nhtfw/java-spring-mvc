                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input class="form-control d-none" type="text" value="${product.id}"
                                            name="id" />
                                        <input class="form-control d-none" type="text" value="${product.quantity}"
                                            name="quantity" id="cartDetails0.quantity" value="1" />
                                        <button
                                            class="btnAddToCartHomepage border border-secondary rounded-pill px-4 py-2 mb-4 text-primary"><i
