(function ($) {
    ...
    $('#btnFilter').click(function (event) {
        // ngăn chặn refresh lại trang của button này
        ...
        let priceArr = [];
        //factory filter
        // lấy ra các input có class .form-check-input và thuộc tính checked trong phần tử có ID #factoryFilter
        ...
        // mỗi một lần lọc, reset về trang 1
        ...
        if (factoryArr.length > 0) {
            // nối chuỗi các phần tử lại, ngăn cách bởi dấu phẩy
